...
public class MessageBuilder {
    ...
    public static String size(int rows) { return "size " + rows; }
    ...
    public static String shot(int r, int c) { return "shot " + r + " " + c; }
    public static String answer(int a) { return "answer " + a; }
    public static String pass() { return "pass"; }
    public static String save(long id) { return "save " + id; }
    public static String load(long id) { return "load " + id; }
