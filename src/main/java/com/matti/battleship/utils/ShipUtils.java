...
public class ShipUtils {
    ...
    /**
     * Retrieves the fields of a 'Ship' where it is placed on.
     * Executes main check that the fields are on the board.
     * 
    ...
    /**
     * Ignores any checks and simply creates reference instances of 'Coordinates' of the ships coordinates.
     * 
     ...
     */
    private static Coordinates[] calcFieldsOfShip(Coordinates shipCoordinates, Direction direction, int length) {
