...
import com.matti.battleship.socket.test.discoverytest.standard.StandardServerConnection;
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.startServer(new MessageListener() {
            ...
            public void onConnectionClosed(Exception e) {
                System.out.println("[SERVER-STANDARD] connection closed: " + (e != null ? e.getMessage() : "null"));
            }
        });

        // Server-Konsoleingaben senden
        System.out.println();
        System.out.println("[SERVER-STANDARD] ✅ Verbunden. Tippe Nachrichten und drücke ENTER. 'exit' beendet.");
