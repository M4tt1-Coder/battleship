...
/**
 * CLIENT TEST (Task 2):
 * - Commands printed ONCE at start
 * - Listening can be started/stopped manually without disconnecting socket
 * - State printed only on "state"
 */
                    ...
                    public void onMessageReceived(String message) {
                        ...
                        switch (st) {
                            ...
                            case C_NEED_OK_AFTER_LOAD ->
                                    log.info("[CLIENT] -> next: type 'ok' to confirm LOAD");
                            case C_NEED_READY ->
                                    log.info("[CLIENT] -> next: type 'start' to send READY");
                            default -> {
                            }
                        }
                    }
