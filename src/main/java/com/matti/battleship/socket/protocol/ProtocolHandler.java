 ...
 *
 * <p>This class implements {@link IMessageListener} so it can receive raw text lines from
 * {@link SocketConnector}. Each received line is parsed using {@link MessageParser} and forwarded
 * as a {@link Message} object to an {@link IProtocolListener}.
 *
...
public class ProtocolHandler implements IMessageListener {
   ...
   * socket because it registers itself as the connector's {@link IMessageListener}.
   *
   ...
   *
   * <p>This method parses the line into a {@link Message} and forwards it to the
   * {@link IProtocolListener}.
   *
   ...
   *
   * <p>LOGIC-IMPORTANT: Close events are forwarded unchanged so higher layers can decide whether
   * to show an error dialog, return to a menu, or attempt reconnect logic.
   *
