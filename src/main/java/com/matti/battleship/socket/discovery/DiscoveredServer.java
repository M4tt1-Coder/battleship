 ...
 * components): - host: IP address of the server - port: TCP port to connect to - name: display name
 * for UI - lastSeenMillis: optional timestamp (can be used for sorting / refreshing UI)
 *
 * <p>Typical GUI usage: - Display: {@code name + " @ " + host + ":" + port} - Connect: {@code
