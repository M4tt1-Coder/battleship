...
public class Scenecontroller3 extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    button1
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root1.widthProperty().multiply(0.02), ";"));
    ...
    label1
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root1.widthProperty().multiply(0.05), ";"));
    ...
    StackPane root2 =
        new StackPane(
            button3, label2, label3, label4, label5, button5, imageView1, combo1, tf1, tf2);
    root2.setId("pane2");
    ...
    button3
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root2.widthProperty().multiply(0.01), ";"));

    button5
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root2.widthProperty().multiply(0.02), ";"));
    ...
    label2
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root2.widthProperty().multiply(0.03), ";"));
    ...
    button4
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root3.widthProperty().multiply(0.01), ";"));
    ...
    Image image2 =
        new Image(getClass().getResource("/com/matti/battleship/picture3.jpg").toExternalForm());
    ...
    button7
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root5.widthProperty().multiply(0.01), ";"));
    ...
    label6
        .styleProperty()
        .bind(Bindings.concat("-fx-font-size: ", root5.widthProperty().multiply(0.03), ";"));
