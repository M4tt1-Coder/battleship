...
public class Chat extends Application {
          ...
          shipLayer.setOnDragDropped(
              ev -> {
                ...
                if (src instanceof StackPane
                    && Boolean.TRUE.equals(src.getProperties().get("onBoard"))) {
  ...
  private StackPane createPlacedShipNode(
      int len, double cellSize, boolean vertical, String resourcePath) {
