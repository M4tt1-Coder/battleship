...
/**
 * Represents a single field on the field. A 'Field' can be identified with its coordinates. When a
 * 'Ship' is placed on a 'Field' 'isOccupied' will be set to TRUE (default FALSE).
 *
 * @author m4tt1
