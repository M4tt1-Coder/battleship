 ...
 * layout.
 *
 * <p>The helper methods bind this image view's properties (position and size) to a parent
 * {@link Pane}'s width/height, allowing the image to scale and move proportionally with the window.
 *
 * @author Thomas Weigl
 */
